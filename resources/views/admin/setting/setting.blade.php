    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                {!! Form::checkbox('active_image_category', 1, !empty($settings['active_image_category']) ? true :
                false, ['class']) !!}
            </div>
        </div>
        <div class="col-md-3">
            <div class="form-group">
                ...
                {!! Form::checkbox('active_image_product', 1, !empty($settings['active_image_product']) ? true : false,
                ['class']) !!}
            </div>
        </div>
        <div class="col-md-3">
            <div class="form-group">
                ...
                {!! Form::checkbox('active_filter_category', 1, !empty($settings['active_filter_category']) ? true :
                false, ['class']) !!}
            </div>
        </div>
        <div class="col-md-3">
            <div class="form-group">
                ...
                {!! Form::checkbox('active_underline', 1, !empty($settings['active_underline']) ? true : false,
                ['class']) !!}
            </div>
        </div>
