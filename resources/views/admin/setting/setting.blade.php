...
@endphp
    ...
    <x-adminlte-card title="{{ __('lang.system_settings') }}" theme="{{ config('adminlte.right_sidebar_theme') }}"
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    {!! Form::label('active_image_category', __('lang.active_image_category'), []) !!} <br>
                    {!! Form::checkbox('active_image_category', 1, !empty($settings['active_image_category']) ? true : false, ['class']) !!}
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    {!! Form::label('active_image_product', __('lang.active_image_product'), []) !!} <br>
                    {!! Form::checkbox('active_image_product', 1, !empty($settings['active_image_product']) ? true : false, ['class']) !!}
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    {!! Form::label('active_filter_category', __('lang.active_filter_category'), []) !!} <br>
                    {!! Form::checkbox('active_filter_category', 1, !empty($settings['active_filter_category']) ? true : false, ['class']) !!}
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    {!! Form::label('active_underline', __('lang.active_underline'), []) !!} <br>
                    {!! Form::checkbox('active_underline', 1, !empty($settings['active_underline']) ? true : false, ['class']) !!}
                </div>
            </div>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/croppie/2.6.5/croppie.min.js"></script>
    ...
    <script>
        ...
        $("[name='active_filter_category']").bootstrapSwitch();
        $("[name='active_image_product']").bootstrapSwitch();
        $("[name='active_image_category']").bootstrapSwitch();
        $("[name='active_underline']").bootstrapSwitch();
